...
export default function App() {
  return (
    <div className=" container flex flex-col w-[1334px] h-[570px] border-solid border-2 border-grey-600 ml-[90px] gap-2 ">
      ...
      <div className="flex gap-2 mx-2.5 my-2.5 ">
        <div className="w-3/4 border-solid border-2 border-grey-600">
          <Overview />
        </div>
